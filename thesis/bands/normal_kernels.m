...
gaps = table(size=[length(dims), 6], VariableTypes=repmat("double", 1, 6), VariableNames={'AutoRbfKernel (Median)', 'AutoRbfKernel (Scaled Median)', 'RbfKernel (p^1/2)', 'LinKernel', 'DetMCD', 'Dimensions'});
...
fig = figure();
plot(gaps,"Dimensions",["AutoRbfKernel (Median)", "AutoRbfKernel (Scaled Median)", "RbfKernel (p^1/2)", "LinKernel", "DetMCD"]);
